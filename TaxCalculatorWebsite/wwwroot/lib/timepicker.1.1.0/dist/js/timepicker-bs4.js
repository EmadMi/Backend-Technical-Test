...
function updatePicker($input)
{
	...
	let html = '<div class="clock-input' + (clock_enabled ? '' : ' d-none') + '">'
		...
		+ '<td class="text-center align-bottom" colspan="3"><a id="' + input_id + '-picker-add-link" class="btn btn-link px-1 mx-0 chevron-btn" data-step="1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_less</i></a></td>'
		...
		+ '<td class="text-center" colspan="3"><a id="' + input_id + '-picker-sub-link" class="btn btn-link px-1 mx-0 chevron-btn" data-step="-1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_more</i></a></td>'
		...
		+ '<td style="width:3rem"><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="hour" data-step="1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_less</i></a></td>'
		+ '<td></td>'
		+ '<td style="width:3rem"><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="minute" data-step="1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_less</i></a></td>'
		+ (has_second ? '<td></td><td style="width:3rem"><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="second" data-step="1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_less</i></a></td>' : '')
		+ (clock_24 ? '' : '<td style="width:3.3rem"><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="meridiem" data-step="1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_less</i></a></td>')
		+ '</tr><tr>'
		...
		+ '</tr><tr>'
		+ '<td><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="hour" data-step="-1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_more</i></a></td>'
		+ '<td></td>'
		+ '<td><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="minute" data-step="-1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_more</i></a></td>'
		+ (has_second ? '<td></td><td><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="second" data-step="-1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_more</i></a></td>' : '')
		+ (clock_24 ? '' : '<td><a class="btn btn-link px-1 mx-0 chevron-btn" data-unit="meridiem" data-step="-1" href="javascript:void(0)"><i class="material-icons-round fs-6 small text-primary">expand_more</i></a></td>')
		+ '</tr></table></div>'
...
jQuery.fn.timepicker = function (options) {
	...
	return this.each(function () {
		...
		$input.on('change', function () {
			...
			placement: 'bottom',
			sanitize: false,
			title: '<button class="btn btn-sm close mt-n1" data-dismiss="popover">&times;</button>' + (($label.length > 0) ? $label.html() : 'Time'),
			template: '<div id="' + input_id + '-picker-popover" class="popover timepicker-popover bs-popover-bottom" role="tooltip"><div class="arrow"></div><h3 class="popover-header d-flex flex-row-reverse align-items-center justify-content-between"></h3><div id="' + input_id + '-popover-body" class="popover-body border-bottom"></div><div class="popover-footer bg-light text-right px-3 py-2 rounded-lg" hidden="hidden"><button type="button" class="btn btn-secondary btn-sm" title="Close the picker" data-dismiss="popover"><i class="fas fa-times"></i> Close</button></div></div>',
